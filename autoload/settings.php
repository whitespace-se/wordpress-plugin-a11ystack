...
add_action("acf/init", function () {
  acf_add_options_sub_page([
    "page_title" => __("Content types", "mu-plugins"),
    "menu_title" => __("Content types", "mu-plugins"),
...
function is_post_type_ui_enabled($post_type) {
  return in_array($post_type, get_ui_enabled_post_types());
}
...
add_action(
  ...
  function () {
    ...
    acf_add_local_field_group([
      ...
      "title" => __("Post type settings", "mu-plugins"),
      "location" => [
        [
          [
            "param" => "options_page",
    ...
    $field = [
      ...
      "label" => __("Enabled post types", "mu-plugins"),
    ...
    //     "label" => sprintf(
    //       __("Enable %s on these post types", "mu-plugins"),
  ...
  function ($args, $post_type_name) {
    ...
    if (
      (in_array($post_type_name, $post_types) ||
        !empty($args["optional_ui"])) &&
      !is_post_type_ui_enabled($post_type_name)
    ) {
      $args["show_ui"] = false;
      $args["public"] = false;
    }
...
//       "title" => __("Taxonomy settings", "mu-plugins"),
//       "location" => [
//         [
//           [
//             "param" => "options_page",
